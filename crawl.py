...
class AsyncCrawler:
    def __init__(self, base_url, max_concurrency, max_pages):
        ...
        self.semaphore = asyncio.Semaphore(int(max_concurrency))
        self.session = None
    ...
    async def crawl_page(self, current_url):
        ...
        for next_url in next_urls:
            self.all_tasks.append(asyncio.create_task(self.crawl_page(next_url)))
...
async def crawl_site_async(base_url, max_concurency, max_pages):
    async with AsyncCrawler(base_url, max_concurency, max_pages) as crawler:
